...
code --install-extension voicevox-tts-2.2.0.vsix
```
...
| GET | `/health` | 稼働確認 |
| GET | `/setup` | コンテナ内で実行するセットアップスクリプトを返す |
